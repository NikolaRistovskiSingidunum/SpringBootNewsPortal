...
@Entity
public class WiseThought {

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	private Integer wisethoughtID;
	...
	protected WiseThought() {
	}

	public WiseThought(Integer newsID, LocalDateTime date, String text, Integer adminID, String title,
			String description, MultipartFile img) {
		super();
		this.wisethoughtID = newsID;
		this.date = date;
		this.text = text;
	...
	public Integer getWisethoughtID() {
		return wisethoughtID;
	}

	public void setWisethoughtID(Integer wisethoughtID) {
		this.wisethoughtID = wisethoughtID;
	}
